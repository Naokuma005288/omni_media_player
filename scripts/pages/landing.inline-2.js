...
const dict={
  ja:{lang:"JP",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",landingTitle:"OmniMedia – ランディング",alpha:"推奨",beta:"mini",old:"非推奨",
      ...
      releasePoint4:"映像連動アンビエントライトなどの既存演出はそのまま維持され、縦長や狭幅では 1 カラムへ自動調整されます。",
  ...
  en:{lang:"EN",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",landingTitle:"OmniMedia – Landing",alpha:"Rec",beta:"mini",old:"Old",
      ...
      releasePoint4:"Ambient light and other video-reactive effects remain active, and portrait or compact widths automatically collapse to a single column.",
  ...
  ko:{lang:"KR",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"추천",beta:"mini",old:"비추천",
      ...
      releasePoint4:"앰비언트 라이트 같은 영상 연동 효과는 유지되며, 세로형이나 좁은 폭에서는 자동으로 1열로 정리됩니다.",
  ...
  zh:{lang:"中文",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"推荐",beta:"mini",old:"旧版",
      ...
      releasePoint4:"环境光等视频联动效果不会被关闭，在竖屏或窄宽度下也会自动收成单列。",
  ...
  ru:{lang:"RU",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"Реком.",beta:"mini",old:"Стар.",
      ...
      releasePoint4:"Ambient light и другие видео-реактивные эффекты сохраняются, а в portrait и узких ширинах интерфейс автоматически переходит в одну колонку.",
  ...
  fr:{lang:"FR",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"Recom.",beta:"mini",old:"Anc.",
      ...
      releasePoint4:"L’ambient light et les autres effets video reactifs restent actifs, et les vues portrait ou compactes passent automatiquement en une seule colonne.",
