...
const themeKey='om.theme', settingsKey='om.settings', favKey='om.favs', accentKey='om.accent', orderKey='om.order', releaseDismissKey='om.release.dismiss.v5.2.0';
...
const dict={
  ja:{lang:"JP",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",landingTitle:"OmniMedia – ランディング",alpha:"推奨",beta:"mini",old:"非推奨",
      ...
      releaseTitle:"v5.2.0 の更新内容",
      releaseLead:"v5.2.0 では通常版の映像フォーカスモードと、landing から直接開ける README ページを追加しました。",
      releasePoint1:"通常版に `映像フォーカス` を追加し、左カラムと上バーだけを隠して映像へ集中できるようにしました。",
      releasePoint2:"映像フォーカス中も下のコントロールバー、映像連動アンビエントライト、既存の映像演出はそのまま維持されます。",
      releasePoint3:"landing ヘッダーから `README` ページへ直接移動できるようになりました。",
      releasePoint4:"README ページは `README.md` をその場で描画し、見出し目次と `Raw README.md` への導線を持ちます。",
  ...
  en:{lang:"EN",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",landingTitle:"OmniMedia – Landing",alpha:"Rec",beta:"mini",old:"Old",
      ...
      releaseTitle:"What is new in v5.2.0",
      releaseLead:"The v5.2.0 release adds a normal-player video focus mode and a README page that opens directly from the landing page.",
      releasePoint1:"The normal player now has a `video focus` mode that hides only the left column and top bar so the stage can take priority.",
      releasePoint2:"Video focus keeps the bottom control dock, ambient light, and other video-reactive effects active instead of stripping the stage down.",
      releasePoint3:"The landing page now has a direct `README` route.",
      releasePoint4:"The README page renders `README.md` in-browser, builds a table of contents from headings, and falls back to an embedded copy when fetch is unavailable.",
  ...
  ko:{lang:"KR",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"추천",beta:"mini",old:"비추천",
      ...
      releaseTitle:"v5.2.0 업데이트",
      releaseLead:"v5.2.0 은 일반 버전의 영상 포커스 모드와, 랜딩에서 바로 열 수 있는 README 페이지를 추가한 릴리스입니다.",
      releasePoint1:"일반 버전에 `영상 포커스` 를 추가해 왼쪽 컬럼과 상단 바만 숨기고 영상에 집중할 수 있게 했습니다.",
      releasePoint2:"영상 포커스 중에도 하단 컨트롤 바, 영상 연동 앰비언트 라이트, 기존 영상 연출은 그대로 유지됩니다.",
      releasePoint3:"landing 헤더에서 `README` 페이지로 바로 이동할 수 있습니다.",
      releasePoint4:"README 페이지는 브라우저 안에서 `README.md` 를 렌더링하고, 목차와 `Raw README.md` 링크도 제공합니다.",
  ...
  zh:{lang:"中文",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"推荐",beta:"mini",old:"旧版",
      ...
      releaseTitle:"v5.2.0 更新内容",
      releaseLead:"v5.2.0 新增了普通版的视频聚焦模式，以及可从 landing 直接打开的 README 页面。",
      releasePoint1:"普通版新增了 `视频聚焦` 模式，只隐藏左侧栏和顶部栏，让画面本身优先显示。",
      releasePoint2:"视频聚焦时仍会保留下方控制栏、视频联动环境光和现有的视频演出效果。",
      releasePoint3:"现在可以从 landing 头部直接进入 `README` 页面。",
      releasePoint4:"README 页面会在浏览器中渲染 `README.md`，并提供目录和 `Raw README.md` 链接。",
  ...
  ru:{lang:"RU",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"Реком.",beta:"mini",old:"Стар.",
      ...
      releaseTitle:"Что нового в v5.2.0",
      releaseLead:"В v5.2.0 добавлены режим фокуса на видео в обычной версии и страница README, которую можно открыть прямо с landing.",
      releasePoint1:"В обычной версии появился режим `video focus`, который скрывает только левую колонку и верхнюю панель, оставляя видео в приоритете.",
      releasePoint2:"В этом режиме сохраняются нижняя панель управления, ambient light и остальные видео-реактивные эффекты.",
      releasePoint3:"На landing теперь есть прямой переход на страницу `README`.",
      releasePoint4:"Страница README рендерит `README.md` в браузере, строит оглавление по заголовкам и имеет fallback на встроенную копию.",
  ...
  fr:{lang:"FR",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"Recom.",beta:"mini",old:"Anc.",
      ...
      releaseTitle:"Nouveautés de v5.2.0",
      releaseLead:"v5.2.0 ajoute un mode de focus video pour la version standard et une page README accessible directement depuis la landing.",
      releasePoint1:"La version standard a maintenant un mode `video focus` qui masque seulement la colonne de gauche et la barre du haut pour laisser la scene au premier plan.",
      releasePoint2:"Ce mode conserve la barre de controle du bas, l’ambient light et les autres effets video reactifs.",
      releasePoint3:"La landing propose maintenant un acces direct a la page `README`.",
      releasePoint4:"La page README rend `README.md` dans le navigateur, construit un sommaire a partir des titres et garde une copie integree en secours.",
