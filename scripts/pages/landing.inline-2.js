...
const themeKey='om.theme', settingsKey='om.settings', favKey='om.favs', accentKey='om.accent', orderKey='om.order', releaseDismissKey='om.release.dismiss.v5.1.0';
...
const dict={
  ja:{lang:"JP",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",landingTitle:"OmniMedia – ランディング",alpha:"推奨",beta:"mini",old:"非推奨",
      ...
      releaseTitle:"v5.1.0 の更新内容",
      releaseLead:"v5.1.0 では通常版の安定性補修、手動 BPM 操作、mini のスマホ seek 圧縮、PWA 配布まわりの更新をまとめました。",
      releasePoint1:"通常版の Auto DJ 更新処理で `ReferenceError` が出続ける問題を修正しました。",
      releasePoint2:"通常版に `manual BPM tap` を追加し、再生中に BPM 表示を左クリックして数回タップすると手動で BPM を合わせられます。",
      releasePoint3:"service worker の precache と fetch 戦略を見直し、古い JS を掴み続ける問題と install 失敗に強くしました。",
      releasePoint4:"mini はスマホ縦持ち時の seek レイアウトを修正し、シークバーが不自然に大きくならないようにしました。",
  ...
  en:{lang:"EN",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",landingTitle:"OmniMedia – Landing",alpha:"Rec",beta:"mini",old:"Old",
      ...
      releaseTitle:"What is new in v5.1.0",
      releaseLead:"The v5.1.0 release bundles normal-player stability fixes, manual BPM control, a tighter mini mobile seek layout, and safer PWA delivery.",
      releasePoint1:"The normal player no longer throws a recurring `ReferenceError` during Auto DJ update and draw.",
      releasePoint2:"`Manual BPM tap` is now available from the BPM readout while playback is running.",
      releasePoint3:"The service worker precache and fetch strategy were hardened to avoid stale JS and single-asset install failures.",
      releasePoint4:"Mini portrait layout now keeps the seek bar compact instead of letting it grow excessively on phones.",
  ...
  ko:{lang:"KR",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"추천",beta:"mini",old:"비추천",
      ...
      releaseTitle:"v5.1.0 업데이트",
      releaseLead:"v5.1.0 은 일반 버전 안정화, 수동 BPM 탭, mini 모바일 seek 레이아웃 보정, PWA 배포 안정화를 묶은 릴리스입니다.",
      releasePoint1:"일반 버전 Auto DJ 갱신 중 반복되던 `ReferenceError` 를 수정했습니다.",
      releasePoint2:"재생 중 BPM 표시를 왼쪽 클릭해 여러 번 탭하면 BPM 을 수동으로 맞출 수 있는 `manual BPM tap` 을 추가했습니다.",
      releasePoint3:"service worker 의 precache 와 fetch 전략을 보강해 오래된 JS 고정과 install 실패에 더 강해졌습니다.",
      releasePoint4:"mini 는 세로 화면 seek 레이아웃을 수정해 휴대폰에서 막대가 과도하게 커지지 않도록 했습니다.",
  ...
  zh:{lang:"中文",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"推荐",beta:"mini",old:"旧版",
      ...
      releaseTitle:"v5.1.0 更新内容",
      releaseLead:"v5.1.0 主要整合了普通版稳定性修复、手动 BPM tap、mini 手机 seek 布局压缩，以及 PWA 分发稳定化。",
      releasePoint1:"修复了普通版 Auto DJ 更新过程中反复出现 `ReferenceError` 的问题。",
      releasePoint2:"普通版新增 `manual BPM tap`，播放中左键点击 BPM 读数并连续点击数次即可手动对 BPM。",
      releasePoint3:"加强了 service worker 的 precache 与 fetch 策略，降低旧 JS 被持续缓存和安装失败的风险。",
      releasePoint4:"mini 修正了手机竖屏下的 seek 布局，避免进度条区域异常变大。",
  ...
  ru:{lang:"RU",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"Реком.",beta:"mini",old:"Стар.",
      ...
      releaseTitle:"Что нового в v5.1.0",
      releaseLead:"В v5.1.0 собраны правки стабильности обычной версии, ручной BPM tap, уплотнение seek-интерфейса mini на телефонах и усиление PWA-доставки.",
      releasePoint1:"Исправлена повторяющаяся ошибка `ReferenceError` в обновлении Auto DJ обычной версии.",
      releasePoint2:"Добавлен `manual BPM tap`: во время воспроизведения можно кликать по индикатору BPM левой кнопкой и вручную задавать темп по серии тапов.",
      releasePoint3:"Стратегия precache/fetch в service worker усилена, чтобы реже залипать на старом JS и не падать из-за одного битого ресурса.",
      releasePoint4:"В mini исправлен seek-лейаут для портретного режима на телефонах, чтобы полоса не разрасталась слишком сильно.",
  ...
  fr:{lang:"FR",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"Recom.",beta:"mini",old:"Anc.",
      ...
      releaseTitle:"Nouveautés de v5.1.0",
      releaseLead:"v5.1.0 regroupe des correctifs de stabilite pour la version standard, un BPM tap manuel, un seek mini resserre sur mobile et une diffusion PWA plus sure.",
      releasePoint1:"Correction du `ReferenceError` recurrent pendant la mise a jour Auto DJ de la version standard.",
      releasePoint2:"Ajout du `manual BPM tap` : pendant la lecture, un clic gauche sur l’indicateur BPM permet de caler le tempo a partir de plusieurs taps.",
      releasePoint3:"Le precache et la strategie fetch du service worker ont ete renforces pour eviter de rester bloque sur un vieux JS et pour mieux tolerer un asset casse.",
      releasePoint4:"Le layout du seek de mini a ete corrige en portrait sur telephone pour qu’il n’occupe plus une place excessive.",
