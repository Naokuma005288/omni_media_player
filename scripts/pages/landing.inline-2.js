...
const themeKey='om.theme', settingsKey='om.settings', favKey='om.favs', accentKey='om.accent', orderKey='om.order', releaseDismissKey='om.release.dismiss.v4.5.0';
...
const dict={
  ja:{lang:"JP",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",landingTitle:"OmniMedia – ランディング",alpha:"推奨",beta:"mini",old:"非推奨",
      ...
      releaseTitle:"v4.5.0 の強化ポイント",
      releaseLead:"通常版の Auto DJ を見直し、Key 手動操作、拍合わせ、動画 handoff を強化しました。",
      releasePoint1:"Auto DJ は Key 同期を外し、BPM ベースで寄せる構成に整理しました。",
      releasePoint2:"MIX カードに Key を追加し、半音単位で手動シフトできるようにしました。",
      releasePoint3:"`mp4 -> mp4` の handoff は次動画の続き位置を保ったまま本体へ移るよう改善しました。",
      releasePoint4:"beatSync 有効時は deck 起動タイミングと映像フェードも拍と音声クロスフェードへ寄せます。",
  ...
  en:{lang:"EN",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",landingTitle:"OmniMedia – Landing",alpha:"Rec",beta:"mini",old:"Old",
      ...
      releaseTitle:"What is new in v4.5.0",
      releaseLead:"The normal player now refines Auto DJ with manual key control, beat alignment, and cleaner video handoff.",
      releasePoint1:"Auto DJ now matches by BPM while Key is handled manually from the MIX card.",
      releasePoint2:"A new Key slider lets you shift playback in semitones without changing the Auto DJ decision.",
      releasePoint3:"`mp4 -> mp4` handoff keeps the live mix position instead of restarting the next video.",
      releasePoint4:"With beatSync on, deck launch timing and video fades follow the beat and audio crossfade more closely.",
  ...
  ko:{lang:"KR",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"추천",beta:"mini",old:"비추천",
      ...
      releaseTitle:"v4.5.0 업데이트",
      releaseLead:"일반 버전의 Auto DJ에 수동 Key 조절, 박자 정렬, 영상 handoff 개선이 추가되었습니다.",
      releasePoint1:"Auto DJ는 이제 Key 자동 동기화 대신 BPM 기준으로 매칭합니다.",
      releasePoint2:"MIX 카드에 Key 슬라이더가 추가되어 반음 단위 수동 조절이 가능합니다.",
      releasePoint3:"`mp4 -> mp4` handoff 시 다음 영상이 처음부터 다시 시작되지 않도록 수정했습니다.",
      releasePoint4:"beatSync 사용 시 deck 시작 타이밍과 영상 페이드가 오디오 크로스페이드에 더 가깝게 맞춰집니다.",
  ...
  zh:{lang:"中文",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"推荐",beta:"mini",old:"旧版",
      ...
      releaseTitle:"v4.5.0 更新内容",
      releaseLead:"普通版进一步强化了 Auto DJ，加入手动 Key、拍点对齐和更稳定的视频交接。",
      releasePoint1:"Auto DJ 现在按 BPM 匹配，Key 改为在 MIX 卡片中手动控制。",
      releasePoint2:"新增 Key 滑块，可按半音调整播放而不改变 Auto DJ 的判断。",
      releasePoint3:"`mp4 -> mp4` 交接会保持当前混音位置，不会再从头重播下一段视频。",
      releasePoint4:"开启 beatSync 后，deck 启动时机和视频淡入淡出会更贴近拍点与音频交叉淡化。",
  ...
  ru:{lang:"RU",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"Реком.",beta:"mini",old:"Стар.",
      ...
      releaseTitle:"Что нового в v4.5.0",
      releaseLead:"Обычная версия улучшает Auto DJ: ручной Key, выравнивание по биту и более чистый handoff видео.",
      releasePoint1:"Auto DJ теперь подстраивается по BPM, а Key управляется вручную из карточки MIX.",
      releasePoint2:"Добавлен ползунок Key для сдвига на полутоны без изменения решения Auto DJ.",
      releasePoint3:"При `mp4 -> mp4` handoff следующее видео больше не перезапускается с начала.",
      releasePoint4:"С включённым beatSync запуск деки и видео-фейды лучше следуют биту и аудио-кроссфейду.",
  ...
  fr:{lang:"FR",footer:"© 2025 OmniMedia – Built with ChatGPT-4o + ChatGPT-5.4",alpha:"Recom.",beta:"mini",old:"Anc.",
      ...
      releaseTitle:"Nouveautés de v4.5.0",
      releaseLead:"La version standard affine Auto DJ avec un contrôle manuel de la tonalité, un calage rythmique et un handoff vidéo plus propre.",
      releasePoint1:"Auto DJ se cale désormais sur le BPM, tandis que la tonalité se règle manuellement depuis la carte MIX.",
      releasePoint2:"Un nouveau curseur Key permet un décalage par demi-tons sans changer la décision d'Auto DJ.",
      releasePoint3:"Le handoff `mp4 -> mp4` conserve la position réelle du mix au lieu de relancer la vidéo suivante depuis le début.",
      releasePoint4:"Avec beatSync activé, le départ du deck et les fondus vidéo suivent mieux le tempo et le crossfade audio.",
